...
|------|---------|--------------|-------------------|----------------|----------|
| 2025-09-09 | 1 | Nature of money | What is money? Why might we want a new kind of money? | Money as a thing: stones, shells, salt, gold; set of functions: medium of exchange, store of value, unit of account; liability (IOU): fiat money and intermediaries. Banking, eCash, Chaumian eCash. | [Aristotle](https://classics.mit.edu/Aristotle/politics.1.one.html) - Politics, Book I, Part IX, [Untraceable Electronic Cash](https://www.wisdom.weizmann.ac.il/~/naor/PAPERS/untrace.pdf)  |
...
| 2025-10-07 | 10 | Market Incentives | How are fees set and why do they matter? |Block size and transaction competition. Mempool mechanics and fee estimation. Fee incentives and markets in Bitcoin and Ethereum. Securely operating an open access P2P network |  |
